...
<link rel="stylesheet" href="/zhangkunPHP/Public/Admin/css/info-mgt.css" />
<link rel="stylesheet" href="/zhangkunPHP/Public/Admin/css/WdatePicker.css" />
<title>my home</title>
<style type='text/css'>
...
<div class="table-operate ue-clear">
	<a href="/zhangkunPHP/index.php/Admin/Doc/add" class="add">添加</a>
...
<div class="table-box">
    <table>
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td class="file"><?php echo ($vol["filename"]); if(!empty($vol["filename"])): ?>【<a href='/zhangkunPHP/index.php/Admin/Doc/download/id/<?php echo ($vol["id"]); ?>'>下载</a>】<?php endif; ?></td>
                ...
                <td class="operate">
                    ...
                    <a href ='/zhangkunPHP/index.php/Admin/Doc/edit/id/<?php echo ($vol["id"]); ?>'>编辑</a>
                </td>
...
<script type="text/javascript" src="/zhangkunPHP/Public/Admin/plugin/layer/layer.js"></script>
...
$(function(){
    ...
    $('.show').on('click',function(){
        ...
        layer.open({
            ...
            shade: 0,   //背景透明
            area: ['560px', '90%'],
            content: '/zhangkunPHP/index.php/Admin/Doc/showContent/id/' + id //iframe的url
        }); 
    });
});
</script>
