	...
	<table>
        ...
        <tbody>
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                ...
                <a href="/zhangkunPHP/index.php/Admin/Dept/edit/id/<?php echo ($vol["id"]); ?>">编辑</a>
                </td>
...
<script type="text/javascript" src="/zhangkunPHP/Public/Admin/js/jquery.pagination.js"></script>
...
$(function(){
	...
	$('.del').on('click',function(){
		...
		//带着参数跳转到del方法
		window.location.href = '/zhangkunPHP/index.php/Admin/Dept/del/id/' + id;
	});
});
</script>
</html>