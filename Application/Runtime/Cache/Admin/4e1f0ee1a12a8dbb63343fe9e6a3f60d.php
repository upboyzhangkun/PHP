...
<style type='text/css'>
	select {
		background: rgba(0, 0, 0, 0) url("http://127.0.0.1/zhangkunPHP//zhangkunPHP/Public/Admin/images/inputbg.png") repeat-x scroll 0 0;
...
<form action="/zhangkunPHP/index.php/Admin/User/add" method="post">
<div class="main">
