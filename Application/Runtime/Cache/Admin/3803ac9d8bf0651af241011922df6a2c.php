...
<body>
    ...
    <div class="table-operate ue-clear">
        <a href="/zhangkunPHP/index.php/Admin/Email/add" class="add">添加</a>
        ...
        <table>
            ...
            <tbody>
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="file"><?php if($vol["hasfile"] == 1): ?><a href='/zhangkunPHP/index.php/Admin/Email/download/id/<?php echo ($vol["id"]); ?>'><?php echo ($vol["filename"]); ?></a><?php endif; ?></td>
...
$(function() {
    ...
    $('.show').on('click', function() {
        ...
        layer.open({
            ...
            area: ['893px', '500px'],
            content: '/zhangkunPHP/index.php/Admin/Email/getContent/id/' + id,
            end: function(){
                //处理关闭的操作
                if(isread == 0){
